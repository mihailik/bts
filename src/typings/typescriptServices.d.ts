declare module TypeScript {
    var DiagnosticCode: {
        ...
        Index_member_declaration_can_only_have_the_static_modifier: string;
        ...
        Interface_0_cannot_simultaneously_extend_types_1_and_2_NL_Types_of_property_3_of_types_1_and_2_are_not_identical: string;
...
declare module TypeScript {
    class ArrayUtilities {
        ...
        static lastOrDefault<T>(array: T[], predicate: (v: T) => boolean): T;
...
declare module TypeScript.LineMap1 {
...
declare module TypeScript.Syntax {
    interface IFactory {
        ...
        getAccessorPropertyAssignment(getKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: TypeScript.ParameterListSyntax, typeAnnotation: TypeScript.TypeAnnotationSyntax, block: TypeScript.BlockSyntax): TypeScript.GetAccessorPropertyAssignmentSyntax;
        setAccessorPropertyAssignment(setKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: TypeScript.ParameterListSyntax, block: TypeScript.BlockSyntax): TypeScript.SetAccessorPropertyAssignmentSyntax;
    ...
    class NormalModeFactory implements IFactory {
        ...
        public getAccessorPropertyAssignment(getKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: TypeScript.ParameterListSyntax, typeAnnotation: TypeScript.TypeAnnotationSyntax, block: TypeScript.BlockSyntax): TypeScript.GetAccessorPropertyAssignmentSyntax;
        public setAccessorPropertyAssignment(setKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: TypeScript.ParameterListSyntax, block: TypeScript.BlockSyntax): TypeScript.SetAccessorPropertyAssignmentSyntax;
...
declare module TypeScript {
    ...
    class AccessorPropertyAssignmentSyntax extends PropertyAssignmentSyntax {
        public parameterList: ParameterListSyntax;
        public block: BlockSyntax;
        constructor(propertyName: TypeScript.ISyntaxToken, parameterList: ParameterListSyntax, block: BlockSyntax, parsedInStrictMode: boolean);
    ...
    class GetAccessorPropertyAssignmentSyntax extends AccessorPropertyAssignmentSyntax {
        public getKeyword: TypeScript.ISyntaxToken;
        public typeAnnotation: TypeAnnotationSyntax;
        constructor(getKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: ParameterListSyntax, typeAnnotation: TypeAnnotationSyntax, block: BlockSyntax, parsedInStrictMode: boolean);
        public accept(visitor: TypeScript.ISyntaxVisitor): any;
        public kind(): TypeScript.SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): TypeScript.ISyntaxElement;
        public update(getKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: ParameterListSyntax, typeAnnotation: TypeAnnotationSyntax, block: BlockSyntax): GetAccessorPropertyAssignmentSyntax;
        static create(getKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: ParameterListSyntax, block: BlockSyntax): GetAccessorPropertyAssignmentSyntax;
    ...
    class SetAccessorPropertyAssignmentSyntax extends AccessorPropertyAssignmentSyntax {
        public setKeyword: TypeScript.ISyntaxToken;
        constructor(setKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: ParameterListSyntax, block: BlockSyntax, parsedInStrictMode: boolean);
        public accept(visitor: TypeScript.ISyntaxVisitor): any;
        public kind(): TypeScript.SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): TypeScript.ISyntaxElement;
        public update(setKeyword: TypeScript.ISyntaxToken, propertyName: TypeScript.ISyntaxToken, parameterList: ParameterListSyntax, block: BlockSyntax): SetAccessorPropertyAssignmentSyntax;
        static create1(propertyName: TypeScript.ISyntaxToken): SetAccessorPropertyAssignmentSyntax;
...
declare module TypeScript.Syntax {
    function isPrimaryExpression(token: TypeScript.ISyntaxToken): boolean;
...
declare module TypeScript {
    ...
    class AST implements IAST {
        ...
        public shouldEmit(emitter: TypeScript.Emitter): boolean;
    ...
    class Script extends AST {
        ...
        constructor(moduleElements: ASTList, _fileName: string, isExternalModule: boolean, amdDependencies: string[]);
        public fileName(): string;
    ...
    class InterfaceDeclaration extends AST {
        ...
        private _varFlags;
        constructor(identifier: Identifier, typeParameterList: ASTList, heritageClauses: ASTList, members: ASTList);
        public nodeType(): TypeScript.NodeType;
        public _isDeclaration(): boolean;
        public getVarFlags(): TypeScript.VariableFlags;
        public setVarFlags(flags: TypeScript.VariableFlags): void;
    ...
    class CastExpression extends AST {
        public castType: TypeReference;
        public operand: AST;
        constructor(castType: TypeReference, operand: AST);
        public nodeType(): TypeScript.NodeType;
        public emitWorker(emitter: TypeScript.Emitter): void;
    ...
    class GetAccessorPropertyAssignment extends AST {
        public propertyName: Identifier;
        public parameterList: ASTList;
        public returnTypeAnnotation: TypeReference;
        public block: Block;
    ...
    class SetAccessorPropertyAssignment extends AST {
        public propertyName: Identifier;
        public parameterList: ASTList;
        public block: Block;
    ...
    class GetMemberAccessorDeclaration extends AST {
        public propertyName: Identifier;
        public parameterList: ASTList;
        public returnTypeAnnotation: TypeReference;
        public block: Block;
    ...
    class SetMemberAccessorDeclaration extends AST {
        public propertyName: Identifier;
        public parameterList: ASTList;
        public block: Block;
        private _functionFlags;
    ...
    class ObjectLiteralExpression extends AST {
        public propertyAssignments: ASTList;
        constructor(propertyAssignments: ASTList);
        public nodeType(): TypeScript.NodeType;
        public emitWorker(emitter: TypeScript.Emitter): void;
    ...
    class VariableDeclarator extends AST {
        ...
        public init: AST;
        private _varFlags;
        constructor(id: Identifier, typeExpr: TypeReference, init: AST);
        public nodeType(): TypeScript.NodeType;
    ...
    class Parameter extends AST {
        ...
        private _varFlags;
        constructor(id: Identifier, typeExpr: TypeReference, init: AST, isOptional: boolean, isRest: boolean);
        public _isDeclaration(): boolean;
        public getVarFlags(): TypeScript.VariableFlags;
        public setVarFlags(flags: TypeScript.VariableFlags): void;
        public nodeType(): TypeScript.NodeType;
    ...
    class ArrowFunctionExpression extends AST {
        public typeParameters: ASTList;
        public parameterList: ASTList;
        public returnTypeAnnotation: TypeReference;
        public block: Block;
    ...
    class EnumDeclaration extends AST {
        public identifier: Identifier;
        public enumElements: ASTList;
        private _moduleFlags;
        constructor(identifier: Identifier, enumElements: ASTList);
        public nodeType(): TypeScript.NodeType;
        public getModuleFlags(): TypeScript.ModuleFlags;
        public setModuleFlags(flags: TypeScript.ModuleFlags): void;
        public _isDeclaration(): boolean;
    ...
    class EnumElement extends AST {
        ...
        constructor(identifier: Identifier, value: AST);
        public nodeType(): TypeScript.NodeType;
        public _isDeclaration(): boolean;
        public emit(emitter: TypeScript.Emitter): void;
    }
    class SwitchStatement extends AST {
        ...
        constructor(val: AST, caseList: ASTList, statement: ASTSpan);
        public nodeType(): TypeScript.NodeType;
        public isStatement(): boolean;
        public emitWorker(emitter: TypeScript.Emitter): void;
    ...
    class TypeParameter extends AST {
        public name: Identifier;
        public constraint: TypeReference;
        constructor(name: Identifier, constraint: TypeReference);
        public nodeType(): TypeScript.NodeType;
        public _isDeclaration(): boolean;
    ...
    function getImplementsHeritageClause(clauses: ASTList): HeritageClause;
...
declare module TypeScript {
    ...
    interface IAstWalkCallback {
        (ast: TypeScript.AST, walker: IAstWalker): void;
    }
    interface IAstWalkChildren {
        (preAst: TypeScript.AST, walker: IAstWalker): void;
    }
    class AstWalkerFactory {
        private childrenWalkers;
        constructor();
        public walk(ast: TypeScript.AST, pre: IAstWalkCallback, post?: IAstWalkCallback, options?: AstWalkOptions, state?: any): void;
...
declare module TypeScript {
    ...
    function lastParameterIsRest(parameters: ASTList): boolean;
    class Emitter {
        ...
        public getConstantDecl(dotExpr: TypeScript.MemberAccessExpression): TypeScript.EnumElement;
        ...
        public getModuleImportAndDependencyList(script: TypeScript.Script): {
            importList: string;
        ...
        public emitArrowFunctionExpression(arrowFunction: TypeScript.ArrowFunctionExpression): void;
        public emitConstructor(funcDecl: TypeScript.ConstructorDeclaration): void;
        public emitGetMemberAccessorDeclaration(funcDecl: TypeScript.GetMemberAccessorDeclaration): void;
        public emitSetMemberAccessorDeclaration(funcDecl: TypeScript.SetMemberAccessorDeclaration): void;
        ...
        public emitList(list: TypeScript.ASTList, useNewLineSeparator?: boolean, startInclusive?: number, endExclusive?: number): void;
        ...
        private emitGetAccessor(funcDecl, className, isProto);
        private emitSetAccessor(funcDecl, className, isProto);
        public emitPropertyAccessor(funcDecl: TypeScript.AST, name: TypeScript.Identifier, className: string, isProto: boolean): void;
        ...
        public emitGetAccessorPropertyAssignment(property: TypeScript.GetAccessorPropertyAssignment): void;
        public emitSetAccessorPropertyAssignment(property: TypeScript.SetAccessorPropertyAssignment): void;
        ...
        public emitScript(script: TypeScript.Script): void;
        private scriptIsElided(script);
        private enumIsElided(declaration);
        private moduleIsElided(declaration);
        private moduleMembersAreElided(members);
        ...
        public emitModuleDeclaration(declaration: TypeScript.ModuleDeclaration): void;
        ...
        private isNotAmbientOrHasInitializer(varDecl);
...
declare module TypeScript {
    ...
    class DeclarationEmitter {
        ...
        private emitDeclarationsForGetMemberAccessorDeclaration(funcDecl);
        private emitDeclarationsForSetMemberAccessorDeclaration(funcDecl);
        private emitPropertyAccessorSignature(funcDecl, flags, name);
        ...
        private emitDeclarationsForScript(script);
    }
}
declare module TypeScript {
    class BloomFilter {
...
declare module TypeScript {
    ...
    class PullDecl {
        ...
        */
        ...
        public setSpecializingSignatureSymbol(specializingSignatureSymbol: TypeScript.PullSignatureSymbol): void;
...
declare module TypeScript {
    ...
    class PullSymbol {
        ...
        private findAliasedType(resolver, externalModule, aliasSymbols?, lookIntoOnlyExportedAlias?, visitedExternalModuleDeclarations?);
        public getAliasedSymbol(resolver: TypeScript.PullTypeResolver, scopeSymbol: PullSymbol): PullTypeAliasSymbol[];
        private isExternalModuleReferenceAlias(aliasSymbol);
        public getScopedDynamicModuleAlias(resolver: TypeScript.PullTypeResolver, scopeSymbol: PullSymbol): PullTypeAliasSymbol[];
        /** Use getName for type checking purposes, and getDisplayName to report an error or display info to the user.
        * They will differ when the identifier is an escaped unicode character or the identifier "__proto__".
        */
        public getName(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, useConstraintInName?: boolean): string;
        public getDisplayName(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, useConstraintInName?: boolean): string;
        ...
        public toString(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, useConstraintInName?: boolean): string;
        public getNamePartForFullName(): string;
        public fullName(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol): string;
        public getScopedName(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, useConstraintInName?: boolean): string;
        public getScopedNameEx(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, useConstraintInName?: boolean, getPrettyTypeName?: boolean, getTypeParamMarkerInfo?: boolean): TypeScript.MemberName;
        public getTypeName(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, getPrettyTypeName?: boolean): string;
        public getTypeNameEx(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, getPrettyTypeName?: boolean): TypeScript.MemberName;
        private getTypeNameForFunctionSignature(prefix, resolver?, scopeSymbol?, getPrettyTypeName?);
        public getNameAndTypeName(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol): string;
        public getNameAndTypeNameEx(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol): TypeScript.MemberName;
        static getTypeParameterString(typars: PullTypeSymbol[], resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, useContraintInName?: boolean): string;
        static getTypeParameterStringEx(typeParameters: PullTypeSymbol[], resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, getTypeParamMarkerInfo?: boolean, useContraintInName?: boolean): TypeScript.MemberNameArray;
    ...
    class PullSignatureSymbol extends PullSymbol {
        ...
        public cachedObjectSpecialization: PullSignatureSymbol;
        ...
        static getSignatureTypeMemberName(candidateSignature: PullSignatureSymbol, signatures: PullSignatureSymbol[], resolver: TypeScript.PullTypeResolver, scopeSymbol: PullSymbol): TypeScript.MemberNameArray;
        static getSignaturesTypeNameEx(signatures: PullSignatureSymbol[], prefix: string, shortform: boolean, brackets: boolean, resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, getPrettyTypeName?: boolean, candidateSignature?: PullSignatureSymbol): TypeScript.MemberName[];
        public toString(resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, useConstraintInName?: boolean): string;
        public getSignatureTypeNameEx(prefix: string, shortform: boolean, brackets: boolean, resolver?: TypeScript.PullTypeResolver, scopeSymbol?: PullSymbol, getParamMarkerInfo?: boolean, getTypeParamMarkerInfo?: boolean): TypeScript.MemberNameArray;
    }
    class PullTypeSymbol extends PullSymbol {
        ...
        private _containedNonMemberContainers;
        ...
        public memberWrapsOwnTypeParameter: boolean;
        ...
        private getMemberTypeNameEx(topLevel, resolver?, scopeSymbol?, getPrettyTypeName?);
    }
    ...
    function signatureWrapsTypeParameter(signature: PullSignatureSymbol, typeParameter: PullTypeParameterSymbol): boolean;
    ...
    function specializeType(typeToSpecialize: PullTypeSymbol, typeArguments: PullTypeSymbol[], resolver: PullTypeResolver, context: PullTypeResolutionContext): PullTypeSymbol;
    function specializeConstraints(newType: PullTypeSymbol, rootTypeParameters: PullTypeParameterSymbol[], typeReplacementMap: {
        [s: string]: PullTypeSymbol;
    }, resolver: PullTypeResolver, context: PullTypeResolutionContext): void;
...
declare module TypeScript {
    ...
    class ArgumentInferenceContext {
        ...
        public inferArgumentTypes(resolver: TypeScript.PullTypeResolver, enclosingDecl: TypeScript.PullDecl, context: PullTypeResolutionContext): {
            results: {
    ...
    var maxRecursiveMemberSpecializationDepth: number;
    var maxRecursiveSignatureSpecializationDepth: number;
    var maxRecursiveConstraintSpecializationDepth: number;
    class PullTypeResolutionContext {
        private resolver;
        public inTypeCheck: boolean;
        public typeCheckUnitPath: string;
        ...
        public isSpecializingSignatureTypeParameters: boolean;
        ...
        public recursiveMemberSpecializationDepth: number;
        public recursiveSignatureSpecializationDepth: number;
        public recursiveConstraintSpecializationDepth: number;
        constructor(resolver: TypeScript.PullTypeResolver, inTypeCheck?: boolean, typeCheckUnitPath?: string);
        ...
        public getTypeSpecializationStack(): any[];
        public setTypeSpecializationStack(newStack: any[]): void;
...
declare module TypeScript {
    ...
    class PullTypeResolver {
        ...
        static typeCheckCallBacks: {
            (context: TypeScript.PullTypeResolutionContext): void;
        }[];
        private static postTypeCheckWorkitems;
        ...
        constructor(compilationSettings: TypeScript.ImmutableCompilationSettings, semanticInfoChain: TypeScript.SemanticInfoChain, unitPath: string, inTypeCheck?: boolean);
        ...
        private getASTForSymbol(symbol, context);
        public getASTForDecl(decl: TypeScript.PullDecl): TypeScript.AST;
        private getNewErrorTypeSymbol(name?);
        ...
        private isNumberOrEquivalent(type);
        public isTypeArgumentOrWrapper(type: TypeScript.PullTypeSymbol): boolean;
        ...
        private resolveOtherDeclarations(ast, context);
        private resolveScript(script, enclosingDecl, context);
        private typeCheckScript(script, enclosingDecl, context);
        ...
        private postTypeCheckClassDeclaration(classDeclAST, enclosingDecl, context);
        ...
        private resolveExportAssignmentStatement(exportAssignmentAST, enclosingDecl, context);
        private resolveFunctionTypeSignature(funcDeclAST, enclosingDecl, context);
        ...
        private checkNameForCompilerGeneratedDeclarationCollision(astWithName, isDeclaration, name, enclosingDecl, context);
        private checkIndexOfRestArgumentInitializationCollides(ast, enclosingDecl, context);
        private resolveObjectTypeTypeReference(objectType, enclosingDecl, context);
        private typeCheckInterfaceTypeReference(interfaceDeclAST, context);
        ...
        private computeTypeReferenceSymbolWorker(term, enclosingDecl, context);
        ...
        private resolveVariableDeclarator(varDecl, context, enclosingDecl?);
        private resolveParameter(parameter, context, enclosingDecl?);
        private getEnumTypeSymbol(enumElement, context);
        private resolveEnumElement(enumElement, enclosingDecl, context);
        private typeCheckEnumElement(enumElement, enclosingDecl, context);
        private resolveVariableDeclaratorOrParameterOrEnumElement(varDeclOrParameter, name, typeExpr, init, enclosingDecl, context);
        private resolveAndTypeCheckVariableDeclarationTypeExpr(varDeclOrParameter, name, typeExpr, context, enclosingDecl);
        private resolveAndTypeCheckVariableDeclaratorOrParameterInitExpr(varDeclOrParameter, name, typeExpr, init, context, enclosingDecl, typeExprSymbol);
        private typeCheckVariableDeclarator(varDecl, enclosingDecl, context);
        private typeCheckParameter(parameter, enclosingDecl, context);
        private typeCheckVariableDeclaratorOrParameterOrEnumElement(varDeclOrParameter, name, typeExpr, init, enclosingDecl, context);
        private checkSuperCaptureVariableCollides(superAST, isDeclaration, enclosingDecl, context);
        private checkThisCaptureVariableCollides(_thisAST, isDeclaration, enclosingDecl, context);
        private postTypeCheckVariableDeclaratorOrParameter(varDeclOrParameter, enclosingDecl, context);
        ...
        private resolveFunctionBodyReturnTypes(funcDeclAST, block, signature, useContextualType, enclosingDecl, context);
        ...
        private resolveAnyFunctionDeclaration(funcDecl, inContextuallyTypedAssignment, enclosingDecl, context);
        private resolveArrowFunctionExpression(funcDecl, inContextuallyTypedAssignment, enclosingDecl, context);
        ...
        private typeCheckVoidExpression(ast, enclosingDecl, context);
        private resolveLogicalOperation(ast, enclosingDecl, context);
        private typeCheckLogicalOperation(binex, enclosingDecl, context);
        private resolveLogicalNotExpression(ast, enclosingDecl, context);
        private typeCheckLogicalNotExpression(ast, enclosingDecl, context);
        private resolveUnaryArithmeticOperation(ast, enclosingDecl, context);
        private resolvePostfixUnaryExpression(ast, enclosingDecl, context);
        private isAnyOrNumberOrEnum(type);
        private typeCheckUnaryArithmeticOperation(unaryExpression, enclosingDecl, context);
        private typeCheckPostfixUnaryExpression(unaryExpression, enclosingDecl, context);
        private resolveBinaryArithmeticExpression(binaryExpression, enclosingDecl, context);
        private typeCheckBinaryArithmeticExpression(binaryExpression, enclosingDecl, context);
        private resolveTypeOfExpression(ast, enclosingDecl, context);
        private typeCheckTypeOfExpression(ast, enclosingDecl, context);
        private resolveThrowStatement(ast, enclosingDecl, context);
        private typeCheckThrowStatement(ast, enclosingDecl, context);
        private resolveDeleteExpression(ast, enclosingDecl, context);
        private typeCheckDeleteExpression(ast, enclosingDecl, context);
        private resolveInstanceOfExpression(ast, enclosingDecl, context);
        private typeCheckInstanceOfExpression(binaryExpression, enclosingDecl, context);
        private resolveCommaExpression(commaExpression, enclosingDecl, context);
        private typeCheckCommaExpression(commaExpression, enclosingDecl, context);
        private resolveInExpression(ast, enclosingDecl, context);
        private typeCheckInExpression(binaryExpression, enclosingDecl, context);
        private resolveForStatement(ast, enclosingDecl, context);
        private typeCheckForStatement(ast, enclosingDecl, context);
        private resolveForInStatement(ast, enclosingDecl, context);
        private typeCheckForInStatement(ast, enclosingDecl, context);
        private resolveWhileStatement(ast, enclosingDecl, context);
        private typeCheckWhileStatement(ast, enclosingDecl, context);
        private resolveDoStatement(ast, enclosingDecl, context);
        private typeCheckDoStatement(ast, enclosingDecl, context);
        private resolveIfStatement(ast, enclosingDecl, context);
        private typeCheckIfStatement(ast, enclosingDecl, context);
        private resolveElseClause(ast, enclosingDecl, context);
        private typeCheckElseClause(ast, enclosingDecl, context);
        ...
        private typeCheckWithStatement(ast, enclosingDecl, context);
        private resolveTryStatement(ast, enclosingDecl, context);
        private typeCheckTryStatement(ast, enclosingDecl, context);
        private resolveCatchClause(ast, enclosingDecl, context);
        private typeCheckCatchClause(ast, enclosingDecl, context);
        private resolveReturnStatement(ast, enclosingDecl, context);
        private resolveSwitchStatement(ast, enclosingDecl, context);
        private typeCheckSwitchStatement(ast, enclosingDecl, context);
        private resolveCaseSwitchClause(ast, enclosingDecl, context);
        private resolveDefaultSwitchClause(ast, enclosingDecl, context);
        private typeCheckCaseSwitchClause(ast, enclosingDecl, context);
        private typeCheckDefaultSwitchClause(ast, enclosingDecl, context);
        private resolveLabeledStatement(ast, enclosingDecl, context);
        private typeCheckLabeledStatement(ast, enclosingDecl, context);
        ...
        private typeCheckAST(ast, inContextuallyTypedAssignment, enclosingDecl, context);
        private processPostTypeCheckWorkItems(context);
        private postTypeCheck(ast, enclosingDecl, context);
        private resolveRegularExpressionLiteral();
        private resolveNameSymbol(nameSymbol, context);
        private postTypeCheckNameExpression(nameAST, enclosingDecl, context);
        private typeCheckNameExpression(nameAST, enclosingDecl, context);
        private resolveNameExpression(nameAST, enclosingDecl, context);
        private computeNameExpression(nameAST, enclosingDecl, context);
        private getCurrentParameterIndexForFunction(ast, funcDecl);
        private resolveMemberAccessExpression(dottedNameAST, enclosingDecl, context);
        private resolveDottedNameExpression(dottedNameAST, expression, name, enclosingDecl, context);
        private isPrototypeMember(expression, name, enclosingDecl, context);
        private computeDottedNameExpression(expression, name, enclosingDecl, context, checkSuperPrivateAndStaticAccess);
        private resolveTypeNameExpression(nameAST, enclosingDecl, context);
        ...
        private resolveQualifiedName(dottedNameAST, enclosingDecl, context);
        private computeQualifiedName(dottedNameAST, enclosingDecl, context);
        ...
        private resolveAnyFunctionExpression(funcDeclAST, typeParameters, parameters, returnTypeAnnotation, block, inContextuallyTypedAssignment, enclosingDecl, context);
        private typeCheckArrowFunctionExpression(arrowFunction, context);
        private typeCheckFunctionPropertyAssignment(funcProp, context);
        private typeCheckAnyFunctionExpression(funcDeclAST, typeParameters, returnTypeAnnotation, block, context);
        private resolveThisExpression(thisExpression, enclosingDecl, context);
        private computeThisTypeSymbol(enclosingDecl, context);
        ...
        private typeCheckThisExpression(thisExpression, enclosingDecl, context);
        private getContextualClassSymbolForEnclosingDecl(enclosingDecl, context);
        private getEnclosingNonLambdaDecl(enclosingDecl);
        private resolveSuperExpression(ast, enclosingDecl, context);
        private typeCheckSuperExpression(ast, enclosingDecl, context);
        private resolveSimplePropertyAssignment(propertyAssignment, inContextuallyTypedAssignment, enclosingDecl, context);
        private resolveFunctionPropertyAssignment(funcProp, inContextuallyTypedAssignment, enclosingDecl, context);
        private resolveGetAccessorPropertyAssignment(propertyAssignment, context);
        private resolveSetAccessorPropertyAssignment(propertyAssignment, context);
        public resolveObjectLiteralExpression(expressionAST: TypeScript.ObjectLiteralExpression, inContextuallyTypedAssignment: boolean, enclosingDecl: TypeScript.PullDecl, context: TypeScript.PullTypeResolutionContext, additionalResults?: PullAdditionalObjectLiteralResolutionData): TypeScript.PullSymbol;
        private tryBindObjectLiteralMembers(objectLiteralDeclaration, objectLiteralTypeSymbol, objectLiteralMembers, isUsingExistingSymbol, boundMemberSymbols, pullTypeContext);
        private resolveObjectLiteralMembers(enclosingDecl, objectLiteralDeclaration, objectLiteralTypeSymbol, objectLiteralContextualType, objectLiteralMembers, stringIndexerSignature, numericIndexerSignature, allMemberTypes, allNumericMemberTypes, boundMemberSymbols, isUsingExistingSymbol, pullTypeContext, additionalResults?);
        private computeObjectLiteralExpression(objectLitAST, inContextuallyTypedAssignment, enclosingDecl, context, additionalResults?);
        ...
        private resolveElementAccessExpression(callEx, enclosingDecl, context);
        private typeCheckElementAccessExpression(callEx, enclosingDecl, context, symbolAndDiagnostic?);
        private computeElementAccessExpressionSymbolAndDiagnostic(callEx, enclosingDecl, context);
        private getBothKindsOfIndexSignatures(enclosingType, context);
        private resolveBinaryAdditionOperation(binaryExpression, enclosingDecl, context);
        private resolveLogicalOrExpression(binex, enclosingDecl, context);
        private bestCommonTypeOfTwoTypes(type1, type2, context);
        private typeCheckLogicalOrExpression(binex, enclosingDecl, context);
        private resolveLogicalAndExpression(binex, enclosingDecl, context);
        private typeCheckLogicalAndExpression(binex, enclosingDecl, context);
        private resolveConditionalExpression(trinex, enclosingDecl, context);
        private typeCheckConditionalExpression(trinex, enclosingDecl, context);
        private resolveParenthesizedExpression(ast, enclosingDecl, context);
        private resolveExpressionStatement(ast, enclosingDecl, context);
        private typeCheckExpressionStatement(ast, enclosingDecl, context);
        public resolveInvocationExpression(callEx: TypeScript.InvocationExpression, enclosingDecl: TypeScript.PullDecl, context: TypeScript.PullTypeResolutionContext, additionalResults?: PullAdditionalCallResolutionData): TypeScript.PullSymbol;
        private typeCheckInvocationExpression(callEx, enclosingDecl, context);
        private computeInvocationExpressionSymbol(callEx, enclosingDecl, context, additionalResults);
        public resolveObjectCreationExpression(callEx: TypeScript.ObjectCreationExpression, enclosingDecl: TypeScript.PullDecl, context: TypeScript.PullTypeResolutionContext, additionalResults?: PullAdditionalCallResolutionData): TypeScript.PullSymbol;
        private typeCheckObjectCreationExpression(callEx, enclosingDecl, context);
        private computeObjectCreationExpressionSymbol(callEx, enclosingDecl, context, additionalResults);
        private resolveCastExpression(assertionExpression, enclosingDecl, context);
        private typeCheckCastExpression(assertionExpression, enclosingDecl, context);
        private resolveAssignmentExpression(binaryExpression, enclosingDecl, context);
        private typeCheckAssignmentExpression(binaryExpression, enclosingDecl, context, leftExpr, rightType);
        ...
        public widenType(ast: TypeScript.AST, type: TypeScript.PullTypeSymbol, enclosingDecl: TypeScript.PullDecl, context: TypeScript.PullTypeResolutionContext): TypeScript.PullTypeSymbol;
        private isNullOrUndefinedType(type);
        public findBestCommonType(initialType: TypeScript.PullTypeSymbol, collection: IPullTypeCollection, context: TypeScript.PullTypeResolutionContext, comparisonInfo?: TypeComparisonInfo): TypeScript.PullTypeSymbol;
        ...
        private signaturesAreIdentical(s1, s2, includingReturnType?);
        ...
        private sourceIsSubtypeOfTarget(source, target, context, comparisonInfo?);
        private sourceMembersAreSubtypeOfTargetMembers(source, target, context, comparisonInfo?);
        private sourcePropertyIsSubtypeOfTargetProperty(source, target, sourceProp, targetProp, context, comparisonInfo?);
        private sourceCallSignaturesAreSubtypeOfTargetCallSignatures(source, target, context, comparisonInfo?);
        private sourceConstructSignaturesAreSubtypeOfTargetConstructSignatures(source, target, context, comparisonInfo?);
        private sourceIndexSignaturesAreSubtypeOfTargetIndexSignatures(source, target, context, comparisonInfo?);
        private typeIsSubtypeOfFunction(source, context);
        private signatureGroupIsSubtypeOfTarget(sg1, sg2, context, comparisonInfo?);
        private signatureIsSubtypeOfTarget(s1, s2, context, comparisonInfo?);
        private sourceIsAssignableToTarget(source, target, context, comparisonInfo?, isInProvisionalResolution?);
        private signatureGroupIsAssignableToTarget(sg1, sg2, context, comparisonInfo?);
        private signatureIsAssignableToTarget(s1, s2, context, comparisonInfo?);
        ...
        private overloadIsApplicable(signature, args, enclosingDecl, context, comparisonInfo);
        private overloadIsApplicableForArgument(paramType, arg, argIndex, enclosingDecl, context, comparisonInfo);
        private overloadIsApplicableForAnyFunctionExpressionArgument(paramType, arg, typeParameters, parameters, returnTypeAnnotation, block, argIndex, enclosingDecl, context, comparisonInfo);
        private overloadIsApplicableForObjectLiteralArgument(paramType, arg, argIndex, enclosingDecl, context, comparisonInfo);
        private overloadIsApplicableForArrayLiteralArgument(paramType, arg, argIndex, enclosingDecl, context, comparisonInfo);
        private overloadIsApplicableForOtherArgument(paramType, arg, argIndex, enclosingDecl, context, comparisonInfo);
        private overloadIsApplicableForArgumentHelper(paramType, argSym, argumentIndex, comparisonInfo, context);
        private getApplicableSignatures(candidateSignatures, args, comparisonInfo, enclosingDecl, context);
        ...
        private specializeTypeToAny(typeToSpecialize, enclosingDecl, context);
        private specializeSignatureToAny(signatureToSpecialize, enclosingDecl, context);
        private specializeSignatureToObject(signatureToSpecialize, enclosingDecl, context);
        ...
        private checkForThisCaptureInArrowFunction(expression, enclosingDecl);
        ...
        private checkPropertyTypeIdentityBetweenBases(classOrInterface, name, typeSymbol, context);
        private checkAssignability(ast, source, target, enclosingDecl, context);
        private isReference(ast, astSymbol);
        private checkForSuperMemberAccess(expression, name, resolvedName, enclosingDecl, context);
        private checkForPrivateMemberAccess(name, expressionType, resolvedName, enclosingDecl, context);
        private checkForStaticMemberAccess(expression, name, expressionType, resolvedName, enclosingDecl, context);
    }
...
declare module TypeScript {
    ...
    class SemanticInfoChain {
        ...
        private declSpecializingSignatureSymbolMap;
        private declCache;
        private symbolCache;
        ...
        private addPrimitiveType(name, globalDecl);
        private addPrimitiveValue(name, type, globalDecl);
        ...
        public setSpecializingSignatureSymbolForDecl(decl: TypeScript.PullDecl, signatureSymbol: TypeScript.PullSignatureSymbol): void;
        public getSpecializingSignatureSymbolForDecl(decl: TypeScript.PullDecl): TypeScript.PullSignatureSymbol;
...
declare module TypeScript {
    module DeclarationCreator {
        function create(script: TypeScript.Script, semanticInfoChain: TypeScript.SemanticInfoChain): TypeScript.PullDecl;
    }
}
declare module TypeScript {
    class PullSymbolBinder {
        ...
        private static findTypeParameterInCache(name);
        private static addTypeParameterToCache(typeParameter);
        static resetTypeParameterCache(): void;
...
declare module TypeScript.PullHelpers {
    ...
    function getGetterAndSetterFunction(funcDecl: TypeScript.AST, semanticInfoChain: TypeScript.SemanticInfoChain): {
        getter: TypeScript.GetMemberAccessorDeclaration;
        setter: TypeScript.SetMemberAccessorDeclaration;
    };
...
declare module TypeScript {
    class SyntaxTreeToAstVisitor implements TypeScript.ISyntaxVisitor {
        ...
        static visit(syntaxTree: TypeScript.SyntaxTree, fileName: string, compilationSettings: TypeScript.ImmutableCompilationSettings, incrementalAST: boolean): TypeScript.Script;
        ...
        public identifierFromToken(token: TypeScript.ISyntaxToken, isOptional: boolean, stringLiteralIsTextOfIdentifier?: boolean): TypeScript.Identifier;
        ...
        public visitSimpleArrowFunctionExpression(node: TypeScript.SimpleArrowFunctionExpressionSyntax): TypeScript.ArrowFunctionExpression;
        public visitParenthesizedArrowFunctionExpression(node: TypeScript.ParenthesizedArrowFunctionExpressionSyntax): TypeScript.ArrowFunctionExpression;
        ...
        public visitIndexMemberDeclaration(node: TypeScript.IndexMemberDeclarationSyntax): TypeScript.FunctionDeclaration;
        public visitMemberFunctionDeclaration(node: TypeScript.MemberFunctionDeclarationSyntax): TypeScript.FunctionDeclaration;
        public visitGetMemberAccessorDeclaration(node: TypeScript.GetMemberAccessorDeclarationSyntax): TypeScript.GetMemberAccessorDeclaration;
        public visitSetMemberAccessorDeclaration(node: TypeScript.SetMemberAccessorDeclarationSyntax): TypeScript.SetMemberAccessorDeclaration;
        ...
        public visitGetAccessorPropertyAssignment(node: TypeScript.GetAccessorPropertyAssignmentSyntax): TypeScript.GetAccessorPropertyAssignment;
        public visitSetAccessorPropertyAssignment(node: TypeScript.SetAccessorPropertyAssignmentSyntax): TypeScript.SetAccessorPropertyAssignment;
...
declare module TypeScript {
    ...
    class TypeScriptCompiler {
        ...
        public _shouldEmit(script: TypeScript.Script): boolean;
